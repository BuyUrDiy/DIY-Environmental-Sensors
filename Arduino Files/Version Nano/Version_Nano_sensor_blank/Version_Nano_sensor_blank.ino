// Arduino Nano data logger / sensor code.  Version 1 made on 2/1/2024 by A.Rok
// This code is identical to the Pro Mini data logger setup as well. It would also work with an Uno if you use a DS2321 RTC module.
// There are only 2 copies of this for the sake of organization

// This code is a blank template for use with a Nano data logger (and the Pro Mini version too). 
...
// This is for use with the Arduino Nano (or Pro Mini) and DS3231 RTC. 
